...
class Mobile_Search extends StatefulWidget {
  const Mobile_Search({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      child: ListView.builder(
        ...
        itemCount: mobileListResult.length,
