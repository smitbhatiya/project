...
Future<void> usersPostPropertyResi(String category, String postBy, String sr_radio, String pro_type, String projectName, String address, String landmark, String city, String state, String pro_detail, String area, String price, String description, String con_status, String url_link, String first_image) async {
  CollectionReference property = FirebaseFirestore.instance.collection('usersPost');
  var firebaseUser = await FirebaseAuth.instance.currentUser;
  FirebaseAuth auth = FirebaseAuth.instance;
  String uid = auth.currentUser.uid.toString();
  FirebaseFirestore.instance.collection('Users12').document(firebaseUser.uid).collection('usersPost').document().set({
    'category': category,
    'posted by': postBy,
    'sell or rent': sr_radio,
    'property type': pro_type,
