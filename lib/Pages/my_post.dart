                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    width: MediaQuery
                                        ...
                                        .size
                                        .width/2,
                                    child: Text(userPostList[index]['project name'], style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                                  ),
                                ),
                                Expanded(
                                    child: Container(
                                      ...
                                      width: MediaQuery
                                          ...
                                          .size
                                          .width/2,
                                      child: Text(userPostList[index]['price'], style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.indigo)),
                                    )
                                )
                              ],
                            ),
